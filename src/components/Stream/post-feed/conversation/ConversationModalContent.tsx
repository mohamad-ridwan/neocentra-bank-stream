...
import { Send, X, CheckCircle, Heart, MessageSquare } from "lucide-react";
...
export default function ConversationModalContent({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 h-full w-full bg-slate-950 text-slate-100 overflow-hidden rounded-2xl">
      {/* LEFT SIDE: Centered Parent Post Detail (Visible on md and up) */}
      <div className="hidden md:flex flex-col justify-center items-center p-8 border-r border-slate-800/60 bg-slate-900/10 h-full relative">
        {parent ? (
          <div className="w-full max-w-sm bg-slate-900/40 border border-slate-800/80 rounded-2xl p-6 shadow-2xl space-y-4">
            {/* Header */}
            ...
            {/* Footer / Stats */}
            <div className="flex items-center gap-4 text-slate-500 text-xs border-t border-slate-800/60 pt-4">
      ...
      {/* RIGHT SIDE: Conversation content with scrollable comments & fixed bottom comment box */}
      <div className="flex flex-col h-full relative overflow-hidden">
        {/* Close Button positioned at the top-left of the conversation content */}
